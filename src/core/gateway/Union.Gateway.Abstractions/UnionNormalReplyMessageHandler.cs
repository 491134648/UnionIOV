...
using Union.Gateway.Abstractions.Extensions;
...
namespace Union.Gateway.Abstractions
{
    ...
    /// 设备正常消息回复
    /// </summary>
    public class UnionNormalReplyMessageHandler
    {
        protected Dictionary<ushort, MsgIdMethodDelegate> HandlerDict { get; }

        protected delegate byte[] MsgIdMethodDelegate(JT808HeaderPackage package, IUnionSession session);
        protected JT808Serializer JT808Serializer { get; }
        public UnionNormalReplyMessageHandler(
        ...
        public virtual byte[] CommonReply(JT808HeaderPackage request, IUnionSession session, JT808PlatformResult resultCode = JT808PlatformResult.成功)
        {
            if (request.Version == JT808Version.JTT2019)
            {
                byte[] data = JT808Serializer.Serialize(JT808MsgId.平台通用应答.Create_平台通用应答_2019(request.Header.TerminalPhoneNo, new JT808_0x8001()
                {
                    ...
                    JT808PlatformResult = resultCode,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0002(JT808HeaderPackage request, IUnionSession session)
        {
            return CommonReply(request, session);
        }
        /// <summary>
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0004(JT808HeaderPackage request, IUnionSession session)
        {
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x8003(JT808HeaderPackage request, IUnionSession session)
        {
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0005(JT808HeaderPackage request, IUnionSession session)
        {
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0100(JT808HeaderPackage request, IUnionSession session)
        {
            if (request.Version == JT808Version.JTT2019)
            {
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0003(JT808HeaderPackage request, IUnionSession session)
        {
            return CommonReply(request, session);
        }
        /// <summary>
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0102(JT808HeaderPackage request, IUnionSession session)
        {
            return CommonReply(request, session);
        }
        /// <summary>
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0104(JT808HeaderPackage request, IUnionSession session)
        {
            return CommonReply(request, session);
        }
        /// <summary>
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0107(JT808HeaderPackage request, IUnionSession session)
        {
            return CommonReply(request, session);
        }
        /// <summary>
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0108(JT808HeaderPackage request, IUnionSession session)
        {
            return CommonReply(request, session);
        }
        /// <summary>
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0200(JT808HeaderPackage request, IUnionSession session)
        {
            return CommonReply(request, session);
        }
        /// <summary>
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0201(JT808HeaderPackage request, IUnionSession session)
        {
            return CommonReply(request, session);
        }
        /// <summary>
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x8204(JT808HeaderPackage request, IUnionSession session)
        {
            return default;
        }
        /// <summary>
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0500(JT808HeaderPackage request, IUnionSession session)
        {
            return CommonReply(request, session);
        }
        /// <summary>
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0704(JT808HeaderPackage request, IUnionSession session)
        {
            return CommonReply(request, session);
        }
        /// <summary>
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0705(JT808HeaderPackage request, IUnionSession session)
        {
            return CommonReply(request, session);
        }
        /// <summary>
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0800(JT808HeaderPackage request, IUnionSession session)
        {
            return CommonReply(request, session);
        }
        /// <summary>
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0801(JT808HeaderPackage request, IUnionSession session)
        {
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x8801(JT808HeaderPackage request, IUnionSession session)
        {
        ...
        /// <param name="session"></param>
        /// <returns></returns>
        public virtual byte[] Msg0x0900(JT808HeaderPackage request, IUnionSession session)
        {
            return CommonReply(request, session);
        }
    }
